{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyPAsFLyENDzJ1coBkbtUmsM",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/Sairanga-Putta/Pyhton/blob/main/Naive_Bayes.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "DsmDnqK6mA9x",
        "outputId": "868fd943-1341-4322-c6e5-33b80041bd1a"
      },
      "outputs": [
        {
          "output_type": "stream",
          ...
          "text": [
            ...
            "-------------------------------------------------\n",
            "Classifying Given Data : \n",
            "-------------------------------------------------\n",
            "Data:  {'Outlook': 'Overcast', 'Temperature': 'Hot', 'Humidity': 'Normal', 'Wind': 'Weak'}\n",
            "PLAY TENNIS:  Yes\n",
            "-------------------------------------\n",
            "Naive Bayesian Model Accuracy: \n",
            "-------------------------------------\n",
            "Test Data :\n",
            "     Outlook Temperature Humidity    Wind Play Tennis\n",
            "3       Rain        Mild     High    Weak         Yes\n",
